...
const (
	...
	InvalidAggregateID                = "invalid behavior id"
	InvalidAggregate                  = "invalid behavior"
	InvalidAggregateType              = "invalid behavior type"
	...
	TheAggregateHasNoIDPleaseUseSetID = "the behavior has no Id, please use SetID()"
